"""Foundry hosted agent (fully hosted agent runtime in the Foundry Agent Service) — SCAFFOLD ONLY.
...
class FoundryHostedAgentProvider(CouncilProvider):
    """Fail-closed scaffold for the 'hosted_agent' runtime shape."""

    ai_backend_type = "foundry_agents"
    provider_id = "foundry_hosted_agent"
    ...
    def invoke_role(
        ...
        raise ProviderNotConfiguredError(
            "foundry_hosted_agent is a scaffold: live Foundry wiring is deferred and "
